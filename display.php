...
<body topmargin="0" leftmargin="0">
	<form name="form1" method="post" action="Us_Index.aspx" id="form1">
		<div>
...
<?php function display_package_body(){
	...
	?>
<form name="form1" method="post" action="package2warehouse.php"
	id="form1" onsubmit="return checkForm();">
	<div>
		<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE"
			value="">
	</div>

	<div>

		<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION"
			value="/wEWCwLF0bvYCQKT3OCtDQL9gvXvAwL0ucGaDgKuzb9iArOd+s0CAtf+t6QCApX2lZwKAqXtp7sMAufvmvAMAtL2kugIvzp2YbN4IDQC4FqwX7qYGxoysfQ=">
	</div>
	<div>
		<table cellspacing="0" cellpadding="0" width="100%" border="0"
			bgcolor="#ffffff">
														...
														<table border="0" cellpadding="0" cellspacing="0">
															<tbody>
																...
																<tr>
																	<td height="45" width="100%" class="da" align="center"
																		style="text-indent: 25px;"><span
																		id="Us_Left_User_NameStr">王辰 您好！</span>
																	</td>
																</tr>
															</tbody>
														</table>
													...
													<td>
														<table border="0" cellpadding="0" cellspacing="0">
															...
															<tbody>
																...
																<tr>
																	<td></td>
																	<td height="24" class="hei"><a href="Us_ModifyPwd.aspx"
																		class="MainLeft">修改密码</a>
																	</td>
																</tr>
													...
													<td>
														<table border="0" cellpadding="0" cellspacing="0">
															<tbody>
																...
																<tr>
																	<td></td>
																	<td height="28" class="hei"><a href="Us_DebitList.aspx"
																		class="MainLeft">消费记录</a>
																	</td>
																</tr>
																<tr>
																	<td></td>
														...
														<table width="100%" border="0" cellspacing="0"
															...
															<tbody>
																<tr height="30">
																	...
																	</select> <input name="pk_areaid" type="hidden"
																		id="pk_areaid">
																	</td>
																</tr>
																<script>
                                                        ...
                                                        function auotweight()
                                                        {
                                                            ...
                                                            else
                                                            {
																...
																<tr height="30">
																	...
																	<td><input name="pk_expressno" type="text"
																		id="pk_expressno" maxlength="50" tabindex="2"
																		size="20" class="pic_border">&nbsp;&nbsp;或自编包裹号&nbsp;&nbsp;<font
																...
																<tr height="30" style="display: none">
																	...
																	<td><input type="radio" name="pk_iscome_sel" value="1"
																		...
																		type="radio" name="pk_iscome_sel" value="0"
																		disabled="" checked=""
																		onclick="window.document.all.pk_iscome.value=this.value;selcometime();">否&nbsp;&nbsp;&nbsp;&nbsp;<input
																		name="pk_iscome" type="hidden" id="pk_iscome"
																		value="0">&nbsp;此项可保持默认</td>
																</tr>

																<tr height="30" id="tr_cometime" style="display: none">
																	<td class="hei">入库日期：</td>
																	<td><input name="pk_cometime" type="text"
																		id="pk_cometime" class="pic_border"
																		...
																		onclick="SelectDate(document.getElementById('pk_cometime'),'yyyy-MM-dd',0,0)"
																		height="15" src="image/calendar.gif" width="16">
																		&nbsp;<font color="red">无法预计可保持默认</font>
																	</td>
																</tr>
                                                            ...
                                                            {      
																...
																<tr height="30">
																	...
																	<td><textarea name="pk_remark_user" id="pk_remark_user"
																			maxlength="500" class="pic_border" rows="10"
																			cols="70"></textarea>
																	</td>
																</tr>
																...
																<tr height="30">
																	<td width="80"></td>
																	<td><input class="input_bot" type="reset" name=""
																		value="取 消" onclick="window.history.go(-1);"> <input
																		type="submit" name="SendData" value="保 存"
																		id="SendData" class="input_bot"><input name="ID"
																		type="hidden" id="ID"><input name="action"
										...
										<table width="100%" border="0" align="center" cellpadding="0"
											...
											<tbody>
												...
												<tr>
													...
													<td width="100%" height="70" bgcolor="#f4f4f4"
														valign="middle">
														<div align="center" class="hui">君安快递&nbsp;&nbsp; Copyright
															2012 www.junanex.com, All Rights Reserved</div>
													</td>
